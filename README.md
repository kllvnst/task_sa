...
- Пункт 7 и 13 противоречат друг другу. Невозможно одновременно фиксировать цену и обновлять её динамически, поэтому необходимо определить единое поведение цены в корзине, оставив 1 из 2 пунктов.
